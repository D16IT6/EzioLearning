    ...
    public partial class InitDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseCategoryTranslations", x => new { x.CultureId, x.CourseCategoryId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseCategoryTranslations_Cultures_CultureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseCategoryTranslations_CourseCategoryId",
                schema: "Translation",
